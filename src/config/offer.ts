...
// Preço confirmado pelo cliente: R$ 79,90 à vista ou 12x de R$ 8,26 (parcelado com juros,
// já que 12 x 8,26 passa do valor à vista). Deve bater com o que está configurado na Kiwify.
export const PRICE = {
  total: 'R$ 79,90',
  installments: '12x de R$ 8,26',
};
